    ...
    <div>
      <button type={type} className={` ${className}`}>
        ...
        <div className="flex gap-2">
          ...
          <span className="h-1 w-1 bg-none group-hover:bg-orange-400 rounded-full animate-pulse opacity-0 group-hover:opacity-100 [animation-delay:3500ms]"></span>
          <span className="h-1 w-1 bg-none group-hover:bg-orange-400 rounded-full animate-pulse opacity-0 group-hover:opacity-100 [animation-delay:3000ms]"></span>
          <span className="h-1 w-1 bg-none group-hover:bg-orange-400 rounded-full animate-pulse opacity-0 group-hover:opacity-100 [animation-delay:2500ms]"></span>
          <span className="h-1 w-1 bg-none group-hover:bg-orange-400 rounded-full animate-pulse opacity-0 group-hover:opacity-100 [animation-delay:2000ms]"></span>
